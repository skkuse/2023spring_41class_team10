...
class ProblemFieldRelationAdmin(admin.ModelAdmin):
  ...
  @admin.display(description='field', ordering='algorithmfield__field')
  def get_field(self, obj):
    return obj.field.field
  @admin.display(description='problem', ordering='algorithmfield__problem')
...
class TestcaseAdmin(admin.ModelAdmin):
  ...
  @admin.display(description='problem', ordering='testcase__problem')
  def get_problem(self, obj):
    return obj.problem.title
...
class ExecutionAdmin(admin.ModelAdmin):
  ...
  @admin.display(description='problem', ordering='execution__problem')
  def get_problem(self, obj):
    return obj.problem.title
...
class SubmissionAdmin(admin.ModelAdmin):
  search_fields = ["id", "problem__title", "lang", "status", "user"]
  list_display = ("id", "get_problem", "lang", "create_at", "status", "exec_time", "user", "num_pass")
  @admin.display(description='problem', ordering='submission__problem')
  def get_problem(self, obj):
    return obj.problem.title
